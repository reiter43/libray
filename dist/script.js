...
/***/ "./src/js/lib/components/checkbox.js":
/*!*******************************************!*\
  !*** ./src/js/lib/components/checkbox.js ***!
  \*******************************************/
/*! no static exports found */
...
function tab(itemsSelector, contentstSelector) {
  ...
  function run(e) {
    ...
    if (target && (target.classList.contains(itemsSelector.replace(/\./, "")) || target.parentNode.classList.contains(itemsSelector.replace(/\./, "")))) {
      tabs.forEach(el => {
...
/* harmony import */ var _components_checkbox__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./components/checkbox */ "./src/js/lib/components/checkbox.js");
